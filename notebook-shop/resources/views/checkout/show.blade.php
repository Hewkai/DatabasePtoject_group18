                                ...
                                @foreach($items as $item)
                                    <div class="flex gap-4">
                                        ...
                                        <div class="flex-grow">
                                            ...
                                            <p class="text-sm font-semibold text-gray-900 mb-2">${{ number_format($item['price'], 2) }}</p>
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <span class="text-base font-bold text-blue-600">${{ number_format($item['price'] * $item['qty'], 2) }}</span>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                        ...
                        <div class="space-y-3 mb-6">
                            @foreach($cart as $item)
                                <div class="flex justify-between text-sm">
                                    ...
                                    <span class="font-semibold text-gray-900">${{ number_format($item['price'] * $item['qty'], 2) }}</span>
                                </div>
                            @endforeach
